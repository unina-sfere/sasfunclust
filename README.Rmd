...
# sasfunclust 
<!-- badges: start -->
[![R build status](https://github.com/unina-sfere/sasfunclust/workflows/R-CMD-check/badge.svg)](https://github.com/unina-sfere/sasfunclust/actions)
[![Travis build status](https://travis-ci.com/unina-sfere/sasfunclust.svg?token=zEVZzMQzEwHdN1bmyHeE&branch=main)](https://travis-ci.com/unina-sfere/sasfunclust)
[![CRAN status](https://www.r-pkg.org/badges/version/sasfunclust)](https://CRAN.R-project.org/package=sasfunclust)
<!-- badges: end -->
...
The package comprises two main functions `sasfclust` and `sasfclust_cv`. 
...
```
```{r,echo=FALSE}
include_graphics("./man/figures/README-unnamed-chunk-6-1.png")
```
...
```{r,echo=FALSE}
include_graphics("./man/figures/README-unnamed-chunk-8-1.png")
```
