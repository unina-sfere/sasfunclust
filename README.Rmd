...
To apply \code{sasfclust_cv},  sequences of $G$, $\lambda_s$, and $\lambda_l$ should be defined.
```{r }
...
Finally, \code{sasfclust} is applied with $G$, $\lambda_s$, and $\lambda_l$ fixed to their optimal values.
```{r }
